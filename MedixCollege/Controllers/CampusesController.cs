...
namespace MedixCollege.Controllers
{
    public class CampusesController : Controller
    {
        ...
        public async Task<ActionResult> AskQuestion(FormCollection fc)
        {
            ...
            if (fc["Email"].Contains("yandex.com") || fc["Email"].Contains("grazadarmo.pl") || fc["Email"].Contains("3vad.com") || fc["Email"].Contains("startsims.com") || fc["Email"].Contains("turbomail.ovh") || fc["Email"].Contains("3vad.com") || fc["Email"].Contains("toysearch.info") || fc["Email"].Contains("plus11.waw.pl") || fc["Email"].Contains("hdfhgdfhtyuryrehgf.xyz") || fc["Email"].Contains("mail.ru") || fc["Email"].Contains("seem.uz") || fc["Email"].Contains("teletec.net.ua") || fc["Email"].Contains("yandex.ru") || fc["Email"].Contains("rambler.ru"))
            {
                ViewBag.Success = false;
